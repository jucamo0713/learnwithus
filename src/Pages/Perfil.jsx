...
class Perfil extends React.Component {
    ...
    deleteUser = async () => {
        axios.delete(`${this.props.rback}/Usu/deleteUsuario/${UsuarioI[0]?.id_usuario}`)
            .then(res => {
                UsuarioI.splice(0, 1);
                this.setState({
                    boolUser: true
    ...
    putAvatar = () => {
        ...
        axios.put(`${this.props.rback}/Usu/actualizacion-perfil/imagen/${UsuarioI[0]?.id_usuario}`, form)
            .then(res => {
    ...
    putInformacion = async (form) => {
        await axios.put(`${this.props.rback}/Usu/actualizacion-perfil/datos/${UsuarioI[0]?.id_usuario}`, form)
            .then(res => {
    ...
    getUsuarioUserName = async (User) => {
        await axios.get(`${this.props.rback}/Usu/usuario-sesion/${User.value}`)
            .then(res => {
    ...
    getUsuarioCorreo = async (correo) => {
        await axios.get(`${this.props.rback}/Usu/correo-sesion/${correo.value}`)
            .then(res => {
                if (res.data.length > 0) {
                    this.Time(correo, "text", "Correo invalido");
                } else {
