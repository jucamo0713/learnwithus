...
class CrearCursoTeorico extends React.Component {
    ...
    getContenidoT = async () => {
        await axios.get(`${this.props.rback}/Cur/get_cursos_id-ContenidoT/crearContenidoTeorico/${this.props.location.state.idCursoC}`)
            .then(res => {
                this.setState({
    ...
    putContenidoT = () => {
        ...
        console.log(form);
        axios.put(`${this.props.rback}/Cur/put_cursos_contenido-t/CrearCursoTeorico/${this.props.location.state.idCursoC}`, form)
            .then(res => {
