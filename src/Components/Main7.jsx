...
class Main7 extends React.Component {
    ...
    getCursosClase = async () => {
        return axios.get(`${this.props.rback}/Cur/get_cursos_informacion/Clase/${this.state.Clase.id_clase}`)
            .catch(err => {
                if (err) {
                    console.error(err);
                }
    ...
    getUsuariosClase = async () => {
        return axios.get(`${this.props.rback}/UsuCla/get-usuario_claseJOINclases-nombre_apellido/clase/${this.state.Clase.id_clase}`)
            .catch(err => {
                if (err) {
                    console.error(err);
                }
    ...
    getCrearCurso = async () => {
        await axios.get(`${this.props.rback}/Cur/get_cursos_id/misCursos_Clase_CreateCurso/${UsuarioI[0].id_usuario}&${newDate}`)
            .then(res => {
                this.setState({
    ...
    getCursoIniciado = async () => {
        return axios.get(`${this.props.rback}/UsuCur/traer-UsuarioCalificacion/Integrado-Comunidad/${UsuarioI[0].id_usuario}`)
            .catch(err => {
                console.error(err);
            })
    }
    ...
    postNewCurso = async () => {
        ...
        axios.post(`${this.props.rback}/Cur/post_cursos_informacion/misCursos`, form)
            .then(res => {
            }).catch(err => {
                if (err) {
                    console.error(err);
    ...
    postIniciarCurso = async (prop) => {
        ...
        console.log(form);
        axios.post(`${this.props.rback}/UsuCur/user-init-curso/${prop}`, form)
            .then(res => {
                this.setState({
                    IniciarCursoPost: {
                        idCursoC2: prop,
    ...
    EliminarCurso = async (Prop) => {
        await axios.delete(`${this.props.rback}/Cur/delete-curso-informacion/paginas/${Prop}&${UsuarioI[0].id_usuario}`)
            .then(async (res) => {
