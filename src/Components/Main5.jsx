...
class Main5 extends React.Component {
    ...
    getClasesC = async () => {
        await axios.get(`${this.props.rback}/Cla/Get-Clases-Creadas/${UsuarioI[0].id_usuario}`)
            .then(res => {
    ...
    getClasesI = async () => {
        await axios.get(`${this.props.rback}/UsuCla/get-usario_claseJOINclases-todo/${UsuarioI[0].id_usuario}`)
            .then(res => {
    ...
    getUsuarioNotifi = async (prop) => {
        ...
        await axios.get(`${this.props.rback}/Usu/get_clases_usuario-id/clases/${variable}`)
            .then(res => {
                this.setState({
                    CrearClase: res.data
                });
    ...
    getNotificurso = (prop) => {
        return axios.get(`${this.props.rback}/Not/get_notificaciones_uclase/clases/${prop}&${UsuarioI[0].id_usuario}`)
            .catch(err => {
                if (err) {
                    console.error(err);
                }
    ...
    getClaseForId = async (prop) => {
        return axios.get(`${this.props.rback}/Cla/Get-Clases-id_Min/clases/${prop}`)
            .catch(err => {
                if (err) {
                    console.error(err);
                }
    ...
    getFechaClase = async (prop) => {
        await axios.get(`${this.props.rback}/Cla/Get-Clases-id/clases/${newDate}&${UsuarioI[0].id_usuario}`)
            .then(res => {
                let data = res.data;
    ...
    putUsariosClase = async () => {
        axios.put(`${this.props.rback}/Cla/Put-Clases-cantidad_usuarios/Clases/${this.state.ModalClase}`)
            .then(res => {
            }).catch(err => {
                if (err) {
                    console.error(err);
    ...
    postNewClase = async (form) => {
        await axios.post(`${this.props.rback}/Cla/Post-Clases-NuevaClase`, form)
            .then(res => {
    ...
    postNewUsuarioClase = async (id_clase) => {
        ...
        axios.post(`${this.props.rback}/UsuCla/post-usuario_clase-Info/Clases`, form)
            .then(res => {
    ...
    postNotificaciones1 = async (id_clase, prop) => {
        for (let i = 0; i < this.state.UsuariosCrearClase.length; i++) {
            ...
            axios.post(`${this.props.rback}/Not/post_notificaciones_info/Clases`, form)
                .then(res => {
    ...
    deleteClase = async () => {
        await axios.delete(`${this.props.rback}/Cla/Delete-Clases-todo/Clases/${this.state.ModalClase}`)
            .then(res => {
                this.getClasesC();
                this.setState({
                    Modal2: false
    ...
    Salirclase = async () => {
        document.getElementById("carga").style.display = "block";
        await axios.delete(`${this.props.rback}/UsuCla/Delete-Clases-todo/Clases/${this.state.ModalClase}&${UsuarioI[0].id_usuario}`)
            .then(res => {
                this.putUsariosClase();
                this.getClasesI();
                this.setState({
