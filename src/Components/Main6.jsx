...
class Main6 extends React.Component {
    ...
    getCursosI = async () => {
        return axios.get(`${this.props.rback}/UsuCur/traer-cursosIniciados/misCursos/${UsuarioI[0].id_usuario}`)
            .catch(err => {
                console.error(err);
            })
    }
    ...
    getCursosC = async () => {
        return axios.get(`${this.props.rback}/Cur/get_cursos_Mis_cursos/Creados/${UsuarioI[0].id_usuario}`)
            .catch(err => {
                console.error(err);
            })
    }
    ...
    deleteCursoC = async (id) => {
        await axios.delete(`${this.props.rback}/Cur/delete-curso-informacion/paginas/${id}&${UsuarioI[0].id_usuario}`)
            .then(async (res) => {
