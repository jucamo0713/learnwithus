...
class Main4 extends React.Component {
    ...
    getInfoCurso = async () => {
        await axios.get(`${this.props.rback}/Cur/get_cursos-Comunidad_Integrado/Curso/${this.props.location.state.id}`)
            .then(res => {
    ...
    getPreguntas = async () => {
        await axios.get(`${this.props.rback}/Cur/get_preguntas_informacion/ContenidoE/${this.props.location.state.id}`)
            .then(res => {
                this.setState({
                    preguntas: res.data
                });
