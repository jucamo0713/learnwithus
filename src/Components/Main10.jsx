...
class Main10 extends React.Component {
    ...
    getNotificaciones = async () => {
        await axios.get(`${this.props.rback}/Not/get_notificaciones_info/Notificaciones/${UsuarioI[0].id_usuario}&${UsuarioI[0].id_usuario}`)
            .then(res => {
    ...
    deleteNotificacion = async (form2) => {
        axios.delete(`${this.props.rback}/Not/delete_notificaciones_info/Notificaciones/${form2.id_clase}&${form2.id_creador_clase}&${form2.id_otro_usuario}`)
            .then(res => {
                this.getNotificaciones();
            }).catch(err => {
                if (err) {
    ...
    /*TODOS LOS PUT*/
    actualizacionEstado = () => {
        axios.put(`${this.props.rback}/Not/put-notificaciones-estado/Notificaciones/${UsuarioI[0].id_usuario}&${UsuarioI[0].id_usuario}`)
            .then(res => { })
            .catch(err => {
                if (err) {
                    console.error(err);
    ...
    putCantidadUsuarios = (id_clase) =>{
        axios.put(`${this.props.rback}/Cla/Put-Clases-cantidad_usuarios/Clases/${id_clase}`)
        .then(res =>{})
        .catch(err =>{
            if(err){
                console.error(err);
    ...
    AceptarNotifi = async (Notification) => {
        ...
        await axios.get(`${this.props.rback}/Not/get-notificaciones-length/clases/${form2.id_clase}&${form2.id_creador_clase}&${form2.id_otro_usuario}`)
            .then(res => {
                let data = res.data;
                if (data[0].conteo == 1) {
    ...
    RechazarNotifi = async (Notification) => {
        ...
        await axios.get(`${this.props.rback}//get-notificaciones-length/clases/${form2.id_clase}&${form2.id_creador_clase}&${form2.id_otro_usuario}`)
            .then(res => {
                let data = res.data;
                if (data[0].conteo == 1) {
                    this.deleteNotificacion(form2);
